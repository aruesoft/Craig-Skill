...
- **등산 코스**: 총 231개 산 데이터 (산림청 100대 명산 포함, 높이·위치·rank)
...
- 총 231개 산 (`references/mountains.json`) — 산림청 100대 명산 + 블랙야크 명산 + 인기 산
- 코스 상세 데이터: 19개 산
- 기상청 mtId 보유: 20개 산
- 출처: 산림청 선정 100대 명산 eBook (2024), 블랙야크 명산, 국립공원공단, 기상청
